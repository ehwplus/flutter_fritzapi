...
class Device {
  ...
  factory Device.fromJson(Map<String, dynamic> json) {
    ...
    final String model = (json['model'] ??
            (nestedDevice is Map<String, dynamic> ? nestedDevice['model'] : null) ??
            '')
        .toString();
    final String displayName = (json['displayName'] ?? json['name'] ?? model).toString();
    final Iterable<Map<String, dynamic>> units =
        (json['units'] as List?)?.whereType<Map<String, dynamic>>() ??
    ...
    final double? temperature =
        _extractNumber(skills, <String>['currentInCelsius', 'temperature', 'celsius']);
    final double? humidity =
        _extractNumber(skills, <String>['humidity', 'currentRelativeHumidity', 'currentInPercent', 'relativeHumidity']);
    ...
    return Device(
      ...
      model: model,
      category: $enumDecode(
        _$DeviceCategoryEnumMap,
        json['category'],
        unknownValue: DeviceCategory.unknown,
      ),
